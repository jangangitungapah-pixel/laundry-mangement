...
export function AppShell({
  ...
  return (
    ...
    >
      <aside className="hidden border-r border-line bg-[var(--color-navigation)] p-4 text-[var(--color-navigation-text)] lg:block">
        <div className="flex items-center gap-3 border-b border-[var(--color-navigation-border)] pb-4">
